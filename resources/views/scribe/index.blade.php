...
<div class="tocify-wrapper">
    ...
    <ul id="toc">
            ...
            <li>Last updated: August 10 2021</li>
        </ul>
</div>
...
<pre><code class="language-yaml">http://localhost:88</code></pre>
...
<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/customers" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/customers"
);
    ...
    &quot;data&quot;: [
        {
            &quot;id&quot;: 1,
            &quot;name&quot;: &quot;Customer 1&quot;,
            &quot;phone_number&quot;: &quot;+628123456798&quot;,
            &quot;address&quot;: &quot;Some address is here&quot;
        }
    ]
}</code>
 </pre>
...
<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/customers/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/customers/1"
);
...
<form id="form-GETapi-customers--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-customers--id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/customers/{id}</code></b>
                ...
                <input type="number"
               name="id"
               data-endpoint="GETapi-customers--id-"
               data-component="url" required  hidden>
    <br>
<p>The ID of the customer.</p>            </p>
                    </form>
...
<pre><code class="language-bash">curl --request PUT \
    "http://localhost:88/api/customers/8" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
...
<form id="form-PUTapi-customers--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-customers--id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
...
<pre><code class="language-bash">curl --request DELETE \
    "http://localhost:88/api/customers/11" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
...
<form id="form-DELETEapi-customers--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-customers--id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            ...
            <b><code>api/customers/{id}</code></b>
                ...
                <input type="number"
               name="id"
               data-endpoint="DELETEapi-customers--id-"
               data-component="url" required  hidden>
    <br>
<p>The ID of the customer.</p>            </p>
                    </form>
...
<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/products" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/products"
);
...
<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/products/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/products/17"
);
...
<pre><code class="language-bash">curl --request DELETE \
    "http://localhost:88/api/products/13" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
...
<code class="language-json">{
    &quot;message&quot;: &quot;SQLSTATE[23000]: Integrity constraint violation: 1451 Cannot delete or update a parent row: a foreign key constraint fails (`simple_pos`.`order_items`, CONSTRAINT `order_items_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)) (SQL: delete from `products` where `id` = 1)&quot;,
    ...
    &quot;trace&quot;: [
        ...
        {
            &quot;file&quot;: &quot;\/var\/www\/html\/app\/Http\/Controllers\/Api\/ProductController.php&quot;,
            &quot;line&quot;: 84,
            &quot;function&quot;: &quot;delete&quot;,
            &quot;class&quot;: &quot;Illuminate\\Database\\Eloquent\\Model&quot;,
            &quot;type&quot;: &quot;-&gt;&quot;
        ...
        {
            &quot;file&quot;: &quot;\/var\/www\/html\/vendor\/laravel\/framework\/src\/Illuminate\/Cache\/Lock.php&quot;,
            &quot;line&quot;: 94,
...
<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/orders/2" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/orders/2"
);
...
<p>The ID of the order.</p>            </p>
            ...
            <h2 id="endpoints-GETapi-promos">Display a listing of the resource.</h2>
...
<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/promos" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/promos"
);
...
<span id="execution-results-GETapi-promos" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-promos"></code></pre>
</span>
<span id="execution-error-GETapi-promos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-promos"></code></pre>
</span>
<form id="form-GETapi-promos" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-promos" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            ...
            <h2 id="endpoints-POSTapi-promos">Store a newly created resource in storage.</h2>
...
<code class="language-json">{
    &quot;data&quot;: {
        ...
        &quot;discount_percentage&quot;: [
            &quot;The discount percentage field is required.&quot;
        ],
        &quot;minimum_price&quot;: [
            &quot;The minimum price field is required.&quot;
        ],
        &quot;status&quot;: [
...
<span id="execution-results-POSTapi-promos" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-promos"></code></pre>
</span>
<span id="execution-error-POSTapi-promos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-promos"></code></pre>
</span>
<form id="form-POSTapi-promos" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-promos" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-black">POST</small>
            ...
            <h2 id="endpoints-GETapi-promos--id-">Display the specified resource.</h2>
...
<span id="example-requests-GETapi-promos--id-">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request GET \
    --get "http://localhost:88/api/promos/2" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-javascript">const url = new URL(
    "http://localhost:88/api/promos/2"
);
...
<span id="example-responses-GETapi-promos--id-">
            <blockquote>
            <p>Example response (400):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-promos--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-promos--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-promos--id-"></code></pre>
</span>
<span id="execution-error-GETapi-promos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-promos--id-"></code></pre>
</span>
<form id="form-GETapi-promos--id-" data-method="GET"
      data-path="api/promos/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-promos--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-promos--id-"
                    onclick="tryItOut('GETapi-promos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-promos--id-"
                    onclick="cancelTryOut('GETapi-promos--id-');" hidden>Cancel
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-promos--id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/promos/{id}</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
                <b><code>id</code></b>&nbsp;&nbsp;<small>integer</small>  &nbsp;
                <input type="number"
               name="id"
               data-endpoint="GETapi-promos--id-"
               data-component="url" required  hidden>
    <br>
<p>The ID of the promo.</p>            </p>
                    </form>

            <h2 id="endpoints-PUTapi-promos--id-">Update the specified resource in storage.</h2>
...
<span id="example-requests-PUTapi-promos--id-">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request PUT \
    "http://localhost:88/api/promos/13" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
...
<span id="example-responses-PUTapi-promos--id-">
            <blockquote>
            <p>Example response (400):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PUTapi-promos--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-promos--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-promos--id-"></code></pre>
</span>
<span id="execution-error-PUTapi-promos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-promos--id-"></code></pre>
</span>
<form id="form-PUTapi-promos--id-" data-method="PUT"
      data-path="api/promos/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-promos--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-promos--id-"
                    onclick="tryItOut('PUTapi-promos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-promos--id-"
                    onclick="cancelTryOut('PUTapi-promos--id-');" hidden>Cancel
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-promos--id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-darkblue">PUT</small>
            ...
            <b><code>api/promos/{id}</code></b>
                ...
                <input type="number"
               name="id"
               data-endpoint="PUTapi-promos--id-"
               data-component="url" required  hidden>
    <br>
<p>The ID of the promo.</p>            </p>
                    </form>

            <h2 id="endpoints-DELETEapi-promos--id-">Remove the specified resource from storage.</h2>
...
<span id="example-requests-DELETEapi-promos--id-">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request DELETE \
    "http://localhost:88/api/promos/14" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
...
<span id="example-responses-DELETEapi-promos--id-">
            <blockquote>
            <p>Example response (400):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-DELETEapi-promos--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-promos--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-promos--id-"></code></pre>
</span>
<span id="execution-error-DELETEapi-promos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-promos--id-"></code></pre>
</span>
<form id="form-DELETEapi-promos--id-" data-method="DELETE"
      data-path="api/promos/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-promos--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-promos--id-"
                    onclick="tryItOut('DELETEapi-promos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-promos--id-"
                    onclick="cancelTryOut('DELETEapi-promos--id-');" hidden>Cancel
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-promos--id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-red">DELETE</small>
            <b><code>api/promos/{id}</code></b>
                ...
                <input type="number"
               name="id"
               data-endpoint="DELETEapi-promos--id-"
               data-component="url" required  hidden>
    <br>
<p>The ID of the promo.</p>            </p>
                    </form>
